...
#
"""
<plugin key="pywws-MQTT" name="pywws (MQTT)" author="michlv" version="0.0.1" externallink="https://XXX">
    <params>
        ...
        <param field="Mode1" label="Topic" width="200px" required="true" default="/weather/pywws"/>
...
class BasePlugin:
    ...
    def onMessage(self, Connection, Data):
        ...
        if (verb == "CONNACK" and Data['Status'] == 0):
            ...
            a = adapter.get(Devices, Domoticz.Device, Data['Topic'])
            a.processData(Data['Payload'].decode())
    ...
    def doConnect(self):
        ...
        if (Parameters["Port"] == "8883"):
            Protocol = "MQTTS"
        self.mqttConn = Domoticz.Connection(Name="pywws-MQTT", Transport="TCP/IP", Protocol=Protocol, Address=Parameters["Address"], Port=Parameters["Port"])
